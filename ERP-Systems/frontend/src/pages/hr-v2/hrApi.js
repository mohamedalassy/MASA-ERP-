...
export const hrPost = (path, data = {}) =>
  hrApi(path, { method: "POST", body: JSON.stringify(data) });
export const hrPut = (path, data = {}) =>
  hrApi(path, { method: "PUT", body: JSON.stringify(data) });
export const hrPatch = (path, data = {}) =>
  hrApi(path, { method: "PATCH", body: JSON.stringify(data) });
export const hrDelete = (path) =>
  hrApi(path, { method: "DELETE" });